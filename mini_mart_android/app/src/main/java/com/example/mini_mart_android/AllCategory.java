...
import com.example.mini_mart_android.model.AllCategoryModel;
...
public class AllCategory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allCategoryModelList.add(new AllCategoryModel(1, R.drawable.b1));
        allCategoryModelList.add(new AllCategoryModel(2, R.drawable.b2));
        allCategoryModelList.add(new AllCategoryModel(3, R.drawable.b3));
        allCategoryModelList.add(new AllCategoryModel(4, R.drawable.b4));
        allCategoryModelList.add(new AllCategoryModel(5, R.drawable.b1));
        allCategoryModelList.add(new AllCategoryModel(6, R.drawable.b2));
        allCategoryModelList.add(new AllCategoryModel(7, R.drawable.b3));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.b4));
        allCategoryModelList.add(new AllCategoryModel(8, R.drawable.b1));
