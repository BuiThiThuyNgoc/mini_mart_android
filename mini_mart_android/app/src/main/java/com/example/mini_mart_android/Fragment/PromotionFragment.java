...
import com.example.mini_mart_android.MainActivity;
...
public class PromotionFragment extends Fragment {
    private View view;
    ImageView back, imgcartpromotion;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            imgcartpromotion = view.findViewById(R.id.imgcartpromotion);

            imgcartpromotion.setOnClickListener(new View.OnClickListener() {
                @Override
